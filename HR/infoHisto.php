...
?>
      ...
      <div class="container">
      <div class="link">
        <h5><a href="MGRoom_hr.php" class="text-reset">จัดการห้อง</a> > <a href="history.php" class="text-reset">ประวัติพนักงาน</a> > ข้อมูลส่วนตัว</h5>
      </div>
...
<div class="displayScore" style="background-color:#ECDEE3">
  ...
  <div class="imgAnScore">
    <img class="image" src="../images/userpic/<?php echo $row['pic_usr'];?>" class=" mx-auto d-block">
    <div class="scores">
      <p>ผลคะแนนก่อนเรียน</p>
      <?php 
      if($row['pretest'] == -1){
        ?>
