...
.tes{
  ...
  $_SESSION["hour_st"] = $hour_st;
  $_SESSION["min_st"] = $min_st;
  $_SESSION["sec_st"] = $sec_st;
...
<form class="form-horizontal" role="form" id='' method="post" action="po_re.php">
...
include("../database/database.php"); 
    ...
    <?php  $sql2 = "SELECT * 
            FROM postest_ans
            WHERE p_id = ".$row['p_id']." ORDER BY RAND()";
