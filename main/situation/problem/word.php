...
$ProblemWord_Din = date("d-m-Y");
$ProblemWord_Tin = date("H:i:s");

$_SESSION["ProblemWord_Din"] = $ProblemWord_Din;
$_SESSION["ProblemWord_Tin"] = $ProblemWord_Tin;

?>
<!doctype html>
<html lang="en">
  <head>
    <title>คำศัพท์: ปัญหาระหว่างการเข้าพัก</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
document.addEventListener('play', function(e){
  ...
  margin-top: 30px;
   ...
   <div class="text"><h3>คำศัพท์: ปัญหาระหว่างการเข้าพัก</h3></div><br>

   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="problem.php" class="text-reset">ปัญหาระหว่างการเข้าพัก</a> > คำศัพท์</h6>
   </div>
   </div>
    <br>
    
<?php 
$sql = "SELECT* FROM wordFi WHERE name = 'problem'";
    ...
    <tbody class="ta">
        <?php 
         ...
         <?php
                $inpi = $row['wor_sound'];
                ?>
            <audio id="sound<?php echo $mu; ?>" src="../../../sound/word/problem/<?php echo $inpi; ?>"></audio>
