...
$SimWord_Din = date("d-m-Y");
$SimWord_Tin = date("H:i:s");

$_SESSION["SimWord_Din"] = $SimWord_Din;
$_SESSION["SimWord_Tin"] = $SimWord_Tin;

?>
<!doctype html>
<html lang="en">
  <head>
    <title>คำศัพท์: ประโยคที่ใช้บ่อย</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<script type="text/javascript" src="../../../jquery-3.4.1.min.js"></script>
    ...
    <script >
           //กดเล่น 1 ครั้งถ้ากดอีกครั้งจะวนเล่นกลับไปจุดเริ่มต้น เสียงจะไม่หยุด
        //    function clo(pp) {
        //        //console.log("hi");
        //        var music = pp;
        //        var sound = new Audio();
        //        sound.src = '../../../sound/word/sim/' + music;
        //    if (sound.paused) {
        // //  console.log(pp);
        //    sound.play();
        //    }else{
...
document.addEventListener('play', function(e){
  ...
  margin-top: 30px;
   ...
   <div class="text"><h3>คำศัพท์: ประโยคที่ใช้บ่อย</h3></div><br>

   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="simple.php" class="text-reset">ประโยคในชีวิตประจำวัน</a> > คำศัพท์</h6>
   </div>
   </div>
    <br>
...
$sql = "SELECT* FROM word WHERE name = 'sim'";
 ...
 <div class="colo">
    ...
    <tbody class="ta">
        <?php 
         ...
         $inpi = $row['wor_sound'];
         ?>
         <audio id="sound<?php echo $mu; ?>" src="../../../sound/word/sim/<?php echo $inpi; ?>"></audio>
