...
<html lang="en">
  <head>
   ...
   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="recom.php" class="text-reset">แนะนำบริการต่างๆ ภายในโรงแรม</a> > ประโยค</h6>
   </div>
...
//    $num = 1;
    ...
    $sql = "SELECT* FROM ts_recom WHERE tr_id = '5A' ";
        ...
        while($row = mysqli_fetch_assoc($result)){
           ...
           if(!$result2 ){
            ...
            ?> 
                ...
                $inpi = $row2['sen_sound'];
                ?>
                <audio id="sound<?php echo $mu; ?>" src="../../../sound/sentence/recom/<?php echo $inpi; ?>"></audio>
...
document.addEventListener('play', function(e){
    ...
    <div class="text-center" style="color: red;"><h6><a href="recom.php" class="text-reset"> << ย้อนกลับไปหน้าที่แล้ว </a> </h6></div>
      <!-- ปิด cookie -->
