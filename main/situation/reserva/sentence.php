...
$ReserveSentence_Din = date("d-m-Y");
$ReserveSentence_Tin = date("H:i:s");

$_SESSION["ReserveSentence_Din"] = $ReserveSentence_Din;
$_SESSION["ReserveSentence_Tin"] = $ReserveSentence_Tin;
...
<html lang="en">
  <head>
    <title>ประโยค: การจองห้องพัก</title>
    <?php include("../headU.php"); ?>
   
   <!-- start -->
   
   <div class="text"><h3>ประโยค: การจองห้องพัก</h3></div><br>
   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="reserva.php" class="text-reset">การจองห้องพัก</a> > ประโยค</h6>
   </div>
...
//    $num = 1;
    ...
    if(!$result){
        ...
        while($row = mysqli_fetch_assoc($result)){
            ...
            <?php
            $sql2 = "SELECT * FROM test1 WHERE id_sen = ".$row['ts_id']."  AND  name= 'reserve' ";
            ...
            ?> 
                ...
                $inpi = $row2['sen_sound'];
                ?>
                <audio id="sound<?php echo $mu; ?>" src="../../../sound/sentence/reserve/<?php echo $inpi; ?>"></audio>
