...
<html lang="en">
  <head>
    <title>แบบฝึกหัด: การจองห้องพัก</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  margin-top: 30px;
   ...
   <div class="text"><h3>แบบฝึกหัด: การจองห้องพัก</h3></div><br>

   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="reserva.php" class="text-reset">การจองห้องพัก</a> > แบบฝึกหัด</h6>
   </div>
   </div>
