...
$ReserveWord_Din = date("d-m-Y");
$ReserveWord_Tin = date("H:i:s");

$_SESSION["ReserveWord_Din"] = $ReserveWord_Din;
$_SESSION["ReserveWord_Tin"] = $ReserveWord_Tin;
...
document.addEventListener('play', function(e){
  ...
  margin-top: 30px;
   ...
   <div class="text"><h3>คำศัพท์: การจองห้องพัก</h3></div><br>

   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="reserva.php" class="text-reset">การจองห้องพัก</a> > คำศัพท์</h6>
   </div>
...
<?php 
$sql = "SELECT* FROM word WHERE name = 'reserve' ";
    ...
    <tbody class="ta">
        <?php 
         ...
         <?php
                $inpi = $row['wor_sound'];
                ?>
                <audio id="sound<?php echo $mu; ?>" src="../../../sound/word/reserve/<?php echo $inpi; ?>"></audio>
