...
$LocaWord_Din = date("d-m-Y");
$LocaWord_Tin = date("H:i:s");

$_SESSION["LocaWord_Din"] = $LocaWord_Din;
$_SESSION["LocaWord_Tin"] = $LocaWord_Tin;
?>
<!doctype html>
<html lang="en">
  <head>
    <title>คำศัพท์: การสอบถามตำแหน่งสถานที่</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
document.addEventListener('play', function(e){
  ...
  margin-top: 30px;
   ...
   <div class="text"><h3>คำศัพท์: การสอบถามตำแหน่งสถานที่ และบริการเรียกรถแท็กซี่</h3></div><br>

   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="location.php" class="text-reset">การสอบถามตำแหน่งสถานที่ และบริการเรียกรถแท็กซี่</a> > คำศัพท์</h6>
   </div>
   </div>
    <br>
    
<?php 
$sql = "SELECT* FROM wordFi WHERE name = 'location'";
    ...
    <tbody class="ta">
        ...
        $mu = 1;
         ...
         <?php
                $inpi = $row['wor_sound'];
                ?>
                <audio id="sound<?php echo $mu; ?>" src="../../../sound/word/location/<?php echo $inpi; ?>"></audio>
