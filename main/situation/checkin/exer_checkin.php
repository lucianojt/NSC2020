...
<html lang="en">
  <head>
    <title>แบบฝึกหัด: การเช็คอิน</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  margin-top: 30px;
   ...
   <div class="text"><h3>แบบฝึกหัด: การเช็คอิน</h3></div><br>

   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="checkin.php" class="text-reset">การเช็คอิน</a> > แบบฝึกหัด</h6>
   </div>
   </div>
...
.tes{
  ...
  .radio:hover {
    ...
    <div class="text-center" style="color: red;"><h6><a href="checkin.php" class="text-reset"> << ย้อนกลับไปหน้าก่อนหน้า </a> </h6></div>
