...
<html lang="en">
  <head>
   ...
   <div class="text"><p>ประโยค: ชำระเงิน</p></div>
   <div class="container">
  
   <div class="link">
    <h5><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="sentence.php" class="text-reset">รายละเอียดของห้องพัก</a> > ชำระเงิน</h5>
  </div>
