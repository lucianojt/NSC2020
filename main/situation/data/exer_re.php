...
if(isset($_POST["answer"])){
 ...
 foreach ($_POST["answer"] as $value) {
    ...
    //  echo  'hi!! '.$value."<br>" ; 
    $sql = "SELECT * FROM exercise_ans WHERE name = 'data' AND id= '".$value."'  ";
...
if(!$row3 ){
  ...
  $sql2 = "UPDATE scoreExercise SET score_data = '$score' WHERE user_usr = '$use' AND code = '$code' ";
  $result2 = mysqli_query($connection,$sql2);
 
   
  //เพิ่มคะแนนครั้งแรกใน scoreData เพิ่อเก็บจำนวนครั้งที่เล่น
  $sql5 = "INSERT INTO scoreData VALUES(NULL,'$use','$code',$score)";
  $result5 = mysqli_query($connection,$sql5);

  //echo 'เล่นครั้งแรก';
}else{
  //เพิ่มคะแนนคนที่เล่นครั้งที่ 2,3,4,5,....... เพิ่มใน scoreData
  $sql4 = "INSERT INTO scoreData VALUES(NULL,'$use','$code',$score)";
...
?>
<br><br>
<a class="btn btn-primary" href="data.php" role="button">กลับ</a>
</div>
