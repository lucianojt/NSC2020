...
$DetailWord_Din = date("d-m-Y");
$DetailWord_Tin = date("H:i:s");

$_SESSION["DetailWord_Din"] = $DetailWord_Din;
$_SESSION["DetailWord_Tin"] = $DetailWord_Tin;

?>
<!doctype html>
<html lang="en">
  <head>
    <title>คำศัพท์: รายละเอียดของห้องพัก</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
document.addEventListener('play', function(e){
  ...
  margin-top: 30px;
   ...
   <div class="text"><h3>คำศัพท์: รายละเอียดของห้องพัก</h3></div><br>

   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="detail.php" class="text-reset">รายละเอียดของห้องพัก</a> > คำศัพท์</h6>
   </div>
   </div>
    <br>
    
<?php 
$sql = "SELECT* FROM word WHERE name = 'detailreserve'";
    ...
    <tbody class="ta">
        <?php 
         ...
         <?php
                $inpi = $row['wor_sound'];
                ?>
                <audio id="sound<?php echo $mu; ?>" src="../../../sound/word/detailreserve/<?php echo $inpi; ?>"></audio>
