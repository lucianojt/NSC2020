      ...
      <div class="buttom">
        ...
        ?>
          <label class="radio" >
            <div class="test">
              <div class="choice" >
                <input type="radio" value="<?php echo $row2['id'];?> " id='radio1_<?php echo $row2['id']; ?>' name="answer[<?php echo $i; ?>]"/>
              </div>
              <div>
                <p style="color: yellow; font-size: 20px; font-weight: bold;" ><?php  echo $row2['eChi'];?></p><p><?php echo $row2['eEng'];?></p>
              </div>
            </div>
          </label>
        <?php
