...
<html lang="en">
  <head>
    <title>แบบฝึกหัด: การแจ้งออกจากโรงแรม (เช็คเอาท์)</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  margin-top: 30px;
   ...
   <div class="text"><h3>แบบฝึกหัด: การแจ้งออกจากโรงแรม (เช็คเอาท์)</h3></div><br>

   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="out.php" class="text-reset">ปัญหาระหว่างการเข้าพัก</a> > แบบฝึกหัด</h6>
   </div>
   </div>
