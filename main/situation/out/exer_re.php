...
if(isset($_POST["answer"])) {
  foreach ($_POST["answer"] as $value) {
    $sql = "SELECT * FROM exercise_ans WHERE name = 'out' AND id= '".$value."'";
  ...
  if ($result3==TRUE) {
    ...
    if(!$row3 ){
      ...
      $sql2 = "UPDATE scoreExercise SET score_out = '$score' WHERE user_usr = '$use' AND code = '$code' ";
      $result2 = mysqli_query($connection,$sql2);
      //เพิ่มคะแนนครั้งแรกใน scoreOut เพิ่อเก็บจำนวนครั้งที่เล่น
      $sql5 = "INSERT INTO scoreOut VALUES(NULL,'$use','$code',$score)";
      $result5 = mysqli_query($connection,$sql5);
      //echo 'เล่นครั้งแรก';
    }else{
      //เพิ่มคะแนนคนที่เล่นครั้งที่ 2,3,4,5,....... เพิ่มใน scoreOut
      $sql4 = "INSERT INTO scoreOut VALUES(NULL,'$use','$code',$score)";
    ...
    ?>
      <div class="score">
        ...
        <a href="out.php" class="btn btn-outline-light">ตกลง</a>
      </div>
    <?php
  } else {
    ?>
