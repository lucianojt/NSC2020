...
<html lang="en">
  <head>
   ...
   <div class="text"><h3>บทสนทนา: การแจ้งออกจากโรงแรม </h3></div><br>
   <div class="container">
   <div class="link">
   <h6><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="out.php" class="text-reset">การแจ้งออกจากโรงแรม </a> > บทสนทนา</h6>
   </div>
