...
$OutCon_Din = date("d-m-Y");
$OutCon_Tin = date("H:i:s");

$_SESSION["OutCon_Din"] = $OutCon_Din;
$_SESSION["OutCon_Tin"] = $OutCon_Tin;
?>
<!doctype html>
<html lang="en">
  <head>
    <title>บทสนทนา: การแจ้งออกจากโรงแรม</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
   ...
   <div class="text"><p>บทสนทนา: การแจ้งออกจากโรงแรม</p></div>

   <div class="container">
  <div class="link">
    <h5><a href="../../../home/index.php" class="text-reset">หน้าหลัก</a> > <a href="../../situation.php" class="text-reset">สถานการณ์</a> > <a href="out.php" class="text-reset">การแจ้งออกจากโรงแรม </a> > บทสนทนา</h5>
  </div>
   </div><br>
    <div class="container">
...
<?php
 $sql = "SELECT* FROM con_Topic WHERE topic = 'out' ";
 ...
 if(!$result){
   echo 'ไม่สามารถติดต่อ database ได้';
    ...
    <div class="card">
      <?php
      $sql2 = "SELECT* FROM Colo_con_simDa WHERE con_id = ".$row['con_id']." AND name = 'out' ";
      ...
      <div class="card-header">
        <audio controls>
          <source src="../../../sound/conver/out/<?php echo $row['con_sound'];?>" type="audio/mpeg">
          </audio>
      </div>
    </div>
<br>
...
?>
  ...
  <div class="backLink"><h6><a href="out.php" class="text-reset"> << ย้อนกลับไปหน้าที่แล้ว </a> </h6>
  <?php
} else {
