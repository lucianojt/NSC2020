...
?>
      ...
      <div class="container">
      <div class="link">
        <h6><a href="index.php" class="text-reset">ADMIN</a> > <a href="MGRoom_ADMIN.php?code=<?php echo  $room;?>" class="text-reset">จัดการห้อง</a> > <a href="data_situation.php" class="text-reset">ข้อมูลสถานการณ์</a> > ข้อมูล</h6>
      </div>
      </div>
<div class="container">
    <?php 
    ...
    // $sql2 = "SELECT * FROM scoreExercise WHERE user_usr = '".$row['user_usr']."' ";
...
<div class="modal fade" id="checkout" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <div class="backLink"><h6><a href="MGRoom_hr.php" class="text-reset"> << กลับไปหน้าจัดการห้อง </a> </h6>
